...
sub AnyIni {
  ...
  'Anyone of two "systemish" databases';
}

sub UserIni {
  new_from_int OS2::PrfDB::Hini OS2::Prf::System(1), 'User settings database';
}

sub SystemIni {
  new_from_int OS2::PrfDB::Hini OS2::Prf::System(2),'System settings database';
}
...
# Internal structure 0 => HINI, 1 => filename, 2 => appname, 3 => array
# of entries, 4 => iterator.
